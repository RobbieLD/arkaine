...
namespace Server.Arkaine.B2
{
    public class MockB2 : IB2Service
    {
        ...
        public Task<UploadResponse> Upload(string fileName, string contentType, StreamContent content, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        public Task<UploadResponse> UploadParts(string fileName, string contentType, Stream content, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
    }
